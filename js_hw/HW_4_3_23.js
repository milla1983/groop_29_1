const users = [
    {                                     // массив, нужно вывести пользователей с датой регистрации
                                          // 09.10.2021 и 10.10.2021
        firstName: 'John',
        lastName: 'Caper',
        phone: '7436676737634',
...
let someUsers = users.filter(users => users.registrationDate ==='09.10.2021' || users.registrationDate === '10.10.2021');
